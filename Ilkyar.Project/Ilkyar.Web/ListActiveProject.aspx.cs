...
{
    public partial class ListActiveProject : System.Web.UI.Page
    {
        ...
        private void FilterProjectList()
        {
            try
            {
                ...
                filter.Status = Convert.ToInt32(EnumProjectStatusType.Aktif);
                ...
                ActiveProjectListGrid.DataSource = serviceResult.Result.OrderByDescending(o => o.StartDate);
                ActiveProjectListGrid.DataBind();
            }
            catch (Exception ex)
            {
            }
        ...
        protected void ActiveProjectListGrid_ItemCommand(object sender, GridCommandEventArgs e)
        {
