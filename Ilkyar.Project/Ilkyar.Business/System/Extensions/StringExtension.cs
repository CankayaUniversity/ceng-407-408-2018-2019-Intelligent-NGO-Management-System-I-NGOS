...
namespace System
{
    public static partial class StringExtension
    {
        ...
        public static Boolean Like(this String original, String value = "")
        {
            return original.ToUpper(new CultureInfo("tr-TR", false)).Contains(value.ToUpper(new CultureInfo("tr-TR", false)));
        }
    }
}
